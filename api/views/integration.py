...
class IntegrationAPI(generics.GenericAPIView):
    ...
    def get(self, request, pk):
        ...
        try:
            ...
            return Response(_integration_response(integration))
        except TranslationIntegration.DoesNotExist:
            return Response({'enabled': False, 'providers': providers})
    ...
    def delete(self, request, pk):
        ...
        try:
            ...
            return Response({'error': 'No integration configured'}, status=status.HTTP_404_NOT_FOUND)
...
class VerifyIntegrationAPI(generics.GenericAPIView):
    ...
    def post(self, request, pk):
        ...
        try:
            ...
            return Response({'error': 'No integration configured'}, status=status.HTTP_400_BAD_REQUEST)
        ...
        try:
            ...
            return Response({'error': 'Integration verification failed'}, status=status.HTTP_502_BAD_GATEWAY)
