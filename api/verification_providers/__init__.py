...
def get_verification_provider(ai_provider: ProjectAIProvider) -> VerificationProvider:
    ...
    if ai_provider.provider_type == ProjectAIProvider.ProviderType.anthropic:
        return AnthropicVerificationProvider(key, ai_provider.endpoint_url, ai_provider.model_name, timeout, ai_provider.verification_instructions)
    return OpenAIVerificationProvider(key, ai_provider.endpoint_url, ai_provider.model_name, timeout, ai_provider.verification_instructions)
